...
module.exports = __webpack_require__(/*! j:\Projetos\Ionic\SLTec-ionic-firebase-06\src\main.ts */"zUnb");
...
/* harmony import */ var _ngx_pwa_local_storage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ngx-pwa/local-storage */ "8YY3");
...
let AppComponent = class AppComponent {
    ...
    initializeApp() {
        ...
        this.storage.get('userData', { type: 'string' }).subscribe({
            next: ((uData) => {
                ...
                if (uData) {
                    ...
                    this.storage.get('userProfile', { type: 'string' }).subscribe((sData) => {
                        this.userProfile = sData;
                    });
                    // 18.4) Conta mensagens não lidas da caixa de entrada
                    this.fbAuth.currentUser.then(() => {
                        this.fbStore.collection(`messages/${this.userData.uid}/inbox`, ref => ref.where('status', '==', 'Não lida')).valueChanges().subscribe((fbData) => {
        ...
        this.events.subscribe('userProfile', (pData) => {
...
/* harmony import */ var _ngx_pwa_local_storage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ngx-pwa/local-storage */ "8YY3");
...
/* harmony import */ var _fortawesome_free_regular_svg_icons__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @fortawesome/free-regular-svg-icons */ "twK/");
/* harmony import */ var _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @fortawesome/free-brands-svg-icons */ "8tEE");
...
let AppModule = class AppModule {
    ...
    constructor(library) {
        library.addIconPacks(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_15__["fas"], _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_17__["fab"], _fortawesome_free_regular_svg_icons__WEBPACK_IMPORTED_MODULE_16__["far"]);
    }
};
AppModule.ctorParameters = () => [
    { type: _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_14__["FaIconLibrary"] }
];
...
const isLogged = () => Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["redirectLoggedInTo"])(['/']);
const routes = [
    ...
    {
        path: 'info',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-info-info-module */ "pages-info-info-module").then(__webpack_require__.bind(null, /*! ./pages/info/info.module */ "hico")).then(m => m.InfoPageModule)
    },
    {
        path: 'contacts',
    ...
    {
        path: 'test01',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-test01-test01-module */ "pages-test01-test01-module").then(__webpack_require__.bind(null, /*! ./pages/test01/test01.module */ "okAj")).then(m => m.Test01PageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        path: 'test02',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-test02-test02-module */ "pages-test02-test02-module").then(__webpack_require__.bind(null, /*! ./pages/test02/test02.module */ "oDcM")).then(m => m.Test02PageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    ...
    {
        path: 'user/new',
        loadChildren: () => Promise.all(/*! import() | user-new-new-module */[__webpack_require__.e("default~user-edit-edit-module~user-new-new-module"), __webpack_require__.e("user-new-new-module")]).then(__webpack_require__.bind(null, /*! ./user/new/new.module */ "Js6N")).then(m => m.NewPageModule),
    ...
    {
        path: 'user/edit',
        loadChildren: () => Promise.all(/*! import() | user-edit-edit-module */[__webpack_require__.e("default~user-edit-edit-module~user-new-new-module"), __webpack_require__.e("user-edit-edit-module")]).then(__webpack_require__.bind(null, /*! ./user/edit/edit.module */ "26qn")).then(m => m.EditPageModule),
    ...
    // 10.1) Sistema de mensagens (somente logado)
    {
        ...
        loadChildren: () => Promise.all(/*! import() | msg-view-view-module */[__webpack_require__.e("common"), __webpack_require__.e("msg-view-view-module")]).then(__webpack_require__.bind(null, /*! ./msg/view/view.module */ "yqK2")).then(m => m.ViewPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        path: 'msg/send',
        loadChildren: () => Promise.all(/*! import() | msg-send-send-module */[__webpack_require__.e("common"), __webpack_require__.e("msg-send-send-module")]).then(__webpack_require__.bind(null, /*! ./msg/send/send.module */ "oy9T")).then(m => m.SendPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        path: 'msg/inbox',
        loadChildren: () => Promise.all(/*! import() | msg-inbox-inbox-module */[__webpack_require__.e("common"), __webpack_require__.e("msg-inbox-inbox-module")]).then(__webpack_require__.bind(null, /*! ./msg/inbox/inbox.module */ "5ZWC")).then(m => m.InboxPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        path: 'msg/outbox',
        loadChildren: () => Promise.all(/*! import() | msg-outbox-outbox-module */[__webpack_require__.e("common"), __webpack_require__.e("msg-outbox-outbox-module")]).then(__webpack_require__.bind(null, /*! ./msg/outbox/outbox.module */ "hNGJ")).then(m => m.OutboxPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | msg-reply-reply-module */[__webpack_require__.e("common"), __webpack_require__.e("msg-reply-reply-module")]).then(__webpack_require__.bind(null, /*! ./msg/reply/reply.module */ "9f5s")).then(m => m.ReplyPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        ...
        path: 'user/delete',
        loadChildren: () => __webpack_require__.e(/*! import() | user-delete-delete-module */ "user-delete-delete-module").then(__webpack_require__.bind(null, /*! ./user/delete/delete.module */ "yvyI")).then(m => m.DeletePageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
