    ...
    function j9j(module, __webpack_exports__, __webpack_require__) {
      ...
      var MessageComponent = /*#__PURE__*/function () {
        ...
        alertController) {
          ...
          this.pipe = new _angular_common__WEBPACK_IMPORTED_MODULE_10__["DatePipe"]('en_US'); // Formatação da data
        ...
        _createClass(MessageComponent, [{
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      this.messageForm = this.formBuilder.group({
                        ...
                        message: [// 19.10) Mensagem da resposta
                        null, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(5)])]
                      });
          ...
          value: function messageSubmit() {
            ...
            this.fbStore.collection("messages/".concat(this.msgReply.to, "/inbox")).add(this.msgReply).then(function (docRef) {
              // 19.6) Altera status da mensagem
              _this2.msgReply.status = 'Enviada'; // 19.7) Salva mensagem na caixa de saída do remetente

              _this2.fbStore.collection("messages/".concat(_this2.msgReply.from, "/outbox")).doc(docRef.id).set(_this2.msgReply).then(function () {
                // 19.8) Feedback
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this3.router.navigate(['/msg/inbox']);
                          }
                        }]
                      });
